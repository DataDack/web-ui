...
This is the console served at `http://localhost:8080/admin_serverless`. Views live under
...
Serves on `http://localhost:3000/admin_serverless/` and proxies `/v1`, `/function`,
...
clone, and `/admin_serverless` returns 404 until you build the bundle.
