...
export function DayGridPicker({
  ...
  return (
    <div className={cn("rounded-xl border bg-card p-4 text-card-foreground shadow-sm", className)}>
      {label ? (
        <div className="mb-3 text-center text-sm font-medium text-muted-foreground">{label}</div>
      ) : null}
      <div
        role="group"
