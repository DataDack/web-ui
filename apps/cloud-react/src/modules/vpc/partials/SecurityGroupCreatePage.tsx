      ...
      <form onSubmit={(e) => void handleSubmit(onSubmit)(e)} className="mt-8 w-full max-w-xl">
        <div className="rounded-xl border border-border-glass bg-background/50 backdrop-blur-xl shadow-sm p-6 space-y-5">
          <div className="space-y-1.5">
            ...
            <Input {...register("name")} placeholder="my-security-group" className="font-mono" />
          ...
          <div className="space-y-1.5">
            ...
            <Controller
              ...
              render={({ field }) => (
                <Select value={field.value} onValueChange={field.onChange}>
                  ...
                  <SelectContent>
                    <SelectItem value={NO_VPC}>{t("vpc.sgForm.vpcNone")}</SelectItem>
                    {networks.map((n) => (
            ...
            />
            <p className="text-[11px] text-muted-foreground">{t("vpc.sgForm.vpcHint")}</p>
          </div>
