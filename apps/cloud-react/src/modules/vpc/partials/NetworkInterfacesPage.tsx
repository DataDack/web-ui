        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md glass-3">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {t("networkInterfaces.createForm.description")}
                    </DialogDescription>
                </DialogHeader>
                <form
                ...
                >
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Select
                            value={networkId}
                            disabled={vpcs.length === 0}
                            onValueChange={onVpcChange}
                        >
                            <SelectTrigger className="w-full">
                                <SelectValue
                                    placeholder={t("networkInterfaces.createForm.vpcPlaceholder")}
                                />
                            </SelectTrigger>
                            <SelectContent>
                                {vpcs.map((vpc) => (
                ...
                <div className="space-y-1.5">
                    ...
                    <Select value={instanceId} onValueChange={setInstanceId}>
                        <SelectTrigger className="w-full font-mono text-[13px]">
                            <SelectValue
                                placeholder={t("networkInterfaces.attachForm.instancePlaceholder")}
                            />
                        </SelectTrigger>
                        <SelectContent>
        ...
        () => [
            ...
            }),
            {
                ...
                accessorFn: (nic: NetworkInterface) =>
                    subnetNames.get(nic.subnet_id) ?? nic.subnet_id,
            ...
            },
            {
                id: "vpc",
                accessorFn: (nic: NetworkInterface) =>
                    vpcNames.get(nic.network_id) ?? nic.network_id,
            ...
            textColumn<NetworkInterface>({
                ...
                // mislabel the column).
                accessor: (nic) =>
                    nic.availability_zone_id
                        ? azMap.get(nic.availability_zone_id)?.code
                        : undefined,
                muted: true,
                responsive: "md",
            }),
