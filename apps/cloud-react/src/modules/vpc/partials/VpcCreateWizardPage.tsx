        ...
        () => [
            {
                ...
                reviewItems: (values) => [
                    ...
                    { label: t("vpc.wizard.region"), value: values.region, mono: true },
                    {
                        ...
                        value:
                            (resourceGroups ?? []).find((g) => g.id === values.resource_group_id)
                                ?.name ?? values.resource_group_id,
                        mono: true,
                    },
                ],
            },
                                    ...
                                    <div key={s.key} className="space-y-1">
                                        <div className="flex flex-wrap items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                aria-label={
                                                    s.is_public
                                                        ? t("vpc.wizard.makePrivate")
                                                        : t("vpc.wizard.makePublic")
                                                }
                                                title={
                                                    s.is_public
                                                        ? t("vpc.badges.public")
                                                        : t("vpc.badges.private")
                                                }
                                                className={cn(
                                            ...
                                            >
                                                ...
                                                >
                                                    <SelectValue
                                                        placeholder={t(
                                                            "vpc.subnetForm.zonePlaceholder"
                                                        )}
                                                    />
                                                </SelectTrigger>
                                                <SelectContent>
                                        ...
                                        {issue && (
                                            <p className="pl-11 text-[11px] text-destructive">
                                                {issueMessage(issue)}
                                            </p>
                                        )}
                                    </div>
