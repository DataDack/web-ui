...
export function Network404({ className }: Readonly<{ className?: string }>) {
  ...
  return (
    <svg className={className} viewBox="-44 -40 508 244" fill="none" role="img" aria-label="404">
      <defs>
      ...
      <motion.g
        ...
        transition={
          reduce ? undefined : { duration: 4, repeat: Number.POSITIVE_INFINITY, ease: "easeInOut" }
        }
      >
        {edges.map((edge) => (
          <line
