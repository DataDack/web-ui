...
import { Avatar, AvatarFallback, Button, Input, Label, Skeleton } from "@datadack/common-ui"
  ...
  return (
    <div className="space-y-6">
      ...
      <Section variant="panel" title={t("accounts.detail.details")}>
        <form onSubmit={(e) => void handleSubmit(onRename)(e)} className="max-w-xl space-y-5">
