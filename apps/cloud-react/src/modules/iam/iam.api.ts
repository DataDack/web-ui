...
export const iamApi = {
  ...
  simulate: (payload: SimulateRequest) => apiPost<SimulateResult>("/auth/authz/simulate", payload),
  ...
  resendInvitation: (id: string) => apiPost<InvitationResult>(`/auth/invitations/${id}/resend`, {}),
