...
export function UsersListPage() {
    ...
    const [inviteMemberOpen, setInviteMemberOpen] = useState(
                ...
                actions={
                    <>
                        <Button
                            ...
                            size="icon"
                            onClick={() =>
                                void (tab === "invitations" ? refetchInvitations() : refetch())
                            }
                            disabled={activeFetching}
                            aria-label={t("common.refresh")}
                        >
                            <RefreshCw
                                className={`w-4 h-4 ${activeFetching ? "animate-spin" : ""}`}
                            />
                        </Button>
                        {tab === "invitations" ? (
                            <Button
