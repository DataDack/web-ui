...
export const FEATURE_COVERAGE: FeatureCoverage[] = [
  ...
  },
  {
    ...
    group: "security",
    source: "pending",
    note: "The gateway's request filter can express CIDR rules; nothing binds a per-environment allowlist to it yet.",
  },
  {
    slug: "dashboard_rbac",
  ...
  // ── Security & governance ─────────────────────────────────────────────────
  {
    ...
    group: "governance",
    source: "pending",
    note: "The gateway's filter evaluates rules, but the console does not yet own a per-account rule set to count against the limit.",
  },
  {
    ...
    group: "governance",
    source: "pending",
    note: "Same as WAF rules — enforcement exists at the edge, the per-account rule set does not.",
  },
  {
