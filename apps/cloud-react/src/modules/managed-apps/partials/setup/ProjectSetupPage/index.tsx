        ...
        <div className="glass-1 rounded-xl border border-border/60 px-5 py-6">
          ...
          <div className="flex items-start gap-3 border-t border-border/40 pt-5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-[13px] leading-relaxed text-muted-foreground">{state.body}</p>
          ...
          {setup.workflow_outdated && (
            <div className="mt-5 flex items-start gap-3 border-t border-border/40 pt-5">
              ...
              <div className="min-w-0 flex-1">
                <h2 className="text-sm font-semibold">A newer build workflow is available</h2>
                <p className="mt-1 text-[13px] leading-relaxed text-muted-foreground">
                  Your repository merged an earlier version of the workflow file. It keeps building
                  exactly as it does today — taking the update is optional. The Workflow tab shows
                  the file we would propose; updating opens a pull request that replaces the older
                  one with it.
                </p>
                {setup.repo_version > 0 && (
                  <p className="mt-2 font-mono text-[11px] text-muted-foreground">
                    repository v{setup.repo_version} · current v{setup.workflow_version}
                  </p>
                )}
                <Button
                  variant="outline"
