		...
		>
			<DialogContent className="glass-3 sm:max-w-lg">
				<DialogHeader>
					...
					<DialogDescription>
						Tell us what you need and we will price it. This opens a support ticket,
						so the reply lands in a thread you can follow — you are on{" "}
