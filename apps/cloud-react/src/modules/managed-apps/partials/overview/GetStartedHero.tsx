            ...
            <div className="relative grid gap-10 p-8 lg:grid-cols-[minmax(0,1fr)_260px] lg:p-10">
                <div className="min-w-0">
                    <h2 className="text-xl font-bold tracking-tight">
                        Ship from GitHub in three steps
                    </h2>
                    <p className="mt-1.5 max-w-lg text-[13px] text-muted-foreground">
                        Connect a repository and every push to your chosen branch builds and
                        deploys. OpenNext and React today; managed n8n agents are coming soon.
                    </p>
