  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className={cn("text-[13px] font-semibold", TONE_TEXT[state.tone])}>{state.label}</p>
        <p className="mt-0.5 text-[12px] leading-relaxed text-muted-foreground">{state.detail}</p>
      </div>
