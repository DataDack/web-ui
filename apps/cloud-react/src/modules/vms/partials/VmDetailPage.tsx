                                ...
                                <TableRow key={disk.id}>
                                    ...
                                    <TableCell className="px-3 text-right">
                                        <Button
                                            ...
                                            title={
                                                detachBlocked
                                                    ? t("vms.detail.bootDetachBlocked")
                                                    : undefined
                                            }
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                    {provisioning ? (
                        <div className="flex items-center gap-2 text-[12px] text-muted-foreground">
                            ...
                            <span>
                                {t(
                                    "vms.monitoring.provisioning",
                                    "Metrics available once provisioning completes"
                                )}
                            </span>
                        </div>
                    ) : (
            ...
            <Section variant="panel" title={title}>
                <div className="space-y-3">
                    ...
                    <ChartDisabledOverlay
                        label={t(
                            "vms.monitoring.provisioningShort",
                        ...
                        <div className="flex items-center gap-3 text-[11px] text-muted-foreground">
                            <span className="flex items-center gap-1.5">
                                <span
                                    ...
                                    style={{ backgroundColor: PSI_SOME_COLOR }}
                                />
                                Some
                            </span>
                            <span className="flex items-center gap-1.5">
                                <span
                                    className="size-2 rounded-full"
                                    style={{ backgroundColor: PSI_FULL_COLOR }}
                                />
                                Full
                            </span>
                        </div>
