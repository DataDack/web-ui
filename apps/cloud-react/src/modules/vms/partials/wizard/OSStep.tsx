                                ...
                                return (
                                    <motion.button
                                        ...
                                        onClick={() => {
                                            ...
                                            const next =
                                                family.versions.find((v) => v.is_default) ??
                                                family.versions.at(0)
                                            if (next)
                                                ...
                                                <Tooltip key={version.id} delayDuration={300}>
                                                    ...
                                                    >
                                                        <p className="font-semibold">
                                                            {version.name ||
                                                                `${openFamily.display_name} ${version.os_version}`}
                                                        </p>
                                                        {(version.architecture ||
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-[13px] text-muted-foreground mt-1 max-w-sm mx-auto">
                                Pre-configured 1-click applications are currently unavailable.
                                Coming soon!
                            </p>
                        </div>
                    </TabsContent>
