		...
		<div className="space-y-4">
			...
			<div className="flex items-center justify-between pt-4 border-t border-border-glass max-w-sm">
				<div className="space-y-0.5">
					...
					<p className="text-xs text-muted-foreground">Automatically delete this data disk when the instance is terminated.</p>
				</div>
				<Switch
					checked={form.watch("delete_on_termination")}
					onCheckedChange={(checked) => { form.setValue("delete_on_termination", checked); }}
				/>
			</div>
