...
export const superAdminApi = {
    ...
    createPVENode: (payload: CreatePVENodeRequest) =>
        apiPost<PVENode>(`${BASE}/pve-nodes`, payload),
    ...
    getManagerStatus: (id: string) =>
        apiGet<ManagerStatus>(`${BASE}/pve-nodes/${id}/manager-status`),
    ...
    createVMPrice: (payload: CreateVMPriceRequest) =>
        apiPost<VMPrice>(`${BASE}/vm-prices`, payload),
