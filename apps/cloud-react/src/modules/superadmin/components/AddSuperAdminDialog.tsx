    ...
    return (
      <>
        <DialogHeader>
          ...
          <DialogDescription>{t("superAdmin.users.addDialog.description")}</DialogDescription>
        </DialogHeader>
        ...
        <div className="max-h-72 min-h-24 overflow-y-auto rounded-md border">{renderResults()}</div>
      </>
    )
  }
