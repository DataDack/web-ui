...
export const superadminRoutes: RouteObject[] = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                lazy: async () => {
                    const { AccountResourcesPage } =
                        await import("./partials/AccountResourcesPage")
            ...
            },
            {
                ...
                lazy: async () => {
                    const { AdminUserProfilePage } =
                        await import("./partials/AdminUserProfilePage")
            ...
            },
            {
                ...
                lazy: async () => {
                    const { AvailabilityZonesPage } =
                        await import("./partials/AvailabilityZonesPage")
            ...
            },
            {
                path: "load-balancers",
                lazy: async () => {
                    const { LoadBalancersAdminPage } =
                        await import("./partials/LoadBalancersAdminPage")
            ...
            },
            {
                ...
                lazy: async () => {
                    const { AdminSupportTicketsPage } =
                        await import("./partials/AdminSupportTicketsPage")
