...
export function ServiceFormSheet({ open, onOpenChange, service }: Readonly<Props>) {
    ...
    return (
        <FormSheet
            ...
            title={
                isEdit ? t("superAdmin.services.editTitle") : t("superAdmin.services.createTitle")
            }
        ...
        >
            ...
            <Field
                label={t("superAdmin.services.fields.name")}
                required
            ...
            <div className="grid grid-cols-2 gap-3">
                <Field
                    label={t("superAdmin.services.fields.icon")}
                    required
            ...
            <div className="space-y-2.5">
                ...
                {fields.map((f, index) => (
                    <div
                        key={f.id}
                        className="space-y-2 rounded-lg border border-border-glass p-2.5"
                    >
                                ...
                                render={({ field }) => (
                                    <Select value={field.value} onValueChange={field.onChange}>
                                        <SelectTrigger className="flex-1">
                                            <SelectValue
                                                placeholder={t(
                                                    "superAdmin.services.fields.metricSource"
                                                )}
                                            />
                                        </SelectTrigger>
                                        <SelectContent>
