...
export function IPPoolsTab() {
	...
	const stats = [
		{ label: t("superAdmin.staticIps.stats.total"), value: totals.usable, color: "default" as const },
		{
			label: t("superAdmin.staticIps.stats.available"),
			value: totals.available,
			color: "success" as const,
		},
		{ label: t("superAdmin.staticIps.stats.inUse"), value: totals.used, color: "info" as const },
		{ label: t("superAdmin.staticIps.stats.pools"), value: pools.length, color: "default" as const },
	]
