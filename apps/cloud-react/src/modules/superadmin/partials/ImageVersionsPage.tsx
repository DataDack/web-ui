                        ...
                        >
                            <TabsList variant="line">
                                <TabsTrigger value="all">
                                    {t("superAdmin.images.versions.filters.all")} (
                                    {statusCounts.all})
                                </TabsTrigger>
                                <TabsTrigger value="available">
                                    {t("superAdmin.images.versions.status.available")} (
                                    {statusCounts.available})
                                </TabsTrigger>
                                {statusCounts.building > 0 && (
                                    <TabsTrigger value="building">
                                        {t("superAdmin.images.versions.status.building")} (
                                        {statusCounts.building})
                                    </TabsTrigger>
                                )}
                                <TabsTrigger value="deprecated">
                                    {t("superAdmin.images.versions.status.deprecated")} (
                ...
                <div className="flex min-w-0 gap-3">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="mt-1 max-w-2xl text-[13px] leading-5 text-muted-foreground">
                            {textOrFallback(
                                image.description,
                                t("superAdmin.images.versions.noDescription")
                            )}
                        </p>
                    </div>
                </div>
    ...
    return (
        <div>
            ...
            <CreateWizard<FormValues, z.input<typeof schema>>
                ...
                form={form}
                submitLabel={
                    editing ? t("superAdmin.actions.save") : t("superAdmin.actions.create")
                }
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <Switch
                                    ...
                                    onCheckedChange={field.onChange}
                                    aria-label={t(
                                        "superAdmin.images.versions.fields.isMarketplace"
                                    )}
                                />
                            )}
                        />
