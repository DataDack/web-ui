  ...
  return (
    <div>
      <PageHeader
        ...
        title={isEdit ? t("superAdmin.vmPrices.editTitle") : t("superAdmin.vmPrices.createTitle")}
    ...
    <div className="space-y-5">
      <div className="space-y-1.5">
        ...
        <Controller
          ...
          render={({ field }) => {
            ...
            const selected = azs.find((a) => a.id === field.value)
            return (
              <Select value={field.value} onValueChange={field.onChange} disabled={noAZs}>
                <SelectTrigger className="w-full">
                  {selected ? (
                    <span>{selected.code}</span>
                  ) : (
                    <span className="text-muted-foreground">
                      {t("superAdmin.vmPrices.fields.availabilityZonePlaceholder")}
                    </span>
                  )}
                </SelectTrigger>
                <SelectContent>
                  {azs.length === 0 ? (
                    <div className="px-2 py-1.5 text-xs text-muted-foreground">
                      {isLoading ? t("common.loading") : t("superAdmin.vmPrices.fields.noAZs")}
                    </div>
                  ) : (
                    azs.map((a) => (
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <Input {...form.register("generation")} placeholder="gen-2" className="font-mono" />
    ...
    <div className="space-y-5">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <Input {...form.register("gpu_type")} placeholder="A100" className="font-mono" />
