...
export function AvailabilityZoneFormSheet({
  ...
  const regions = useMemo(() => {
    ...
    return Array.from(byCode.values()).sort((a, b) => a.region_name.localeCompare(b.region_name))
  }, [azs])
      ...
      {!isEdit && !newRegion ? (
            ...
            render={({ field }) => (
              ...
              >
                <SelectTrigger className="w-full font-mono">
                  <SelectValue
                    placeholder={t("superAdmin.availabilityZones.fields.regionPlaceholder")}
                  />
                </SelectTrigger>
                <SelectContent>
                  {regions.map((r) => (
                    <SelectItem key={r.region_code} value={r.region_code}>
                      {r.region_name}{" "}
                      <span className="font-mono text-muted-foreground">({r.region_code})</span>
                    </SelectItem>
                  ))}
                  <SelectSeparator />
        ...
        <>
          <Field
            ...
            error={errors.region_code?.message}
          >
            <Input {...register("region_code")} placeholder="noida-ncr" className="font-mono" />
          </Field>
          <Field
          ...
          render={({ field }) => (
            ...
            >
              <SelectTrigger className="w-full">
                <SelectValue
                  placeholder={t("superAdmin.availabilityZones.fields.countryPlaceholder")}
                />
              </SelectTrigger>
              <SelectContent>
                {countries.map((c) => (
