            ...
            <ConfirmDialog
                ...
                description={
                    <div className="space-y-3">
                        <p>
                            This starts teardown for {title}. All active resources will be deleted,
                            including VMs, load balancers, disks, VPC resources, and related
                            networking state.
                        </p>
                        <ul className="list-disc space-y-1 pl-4">
                            <li>Static IPs will be released back to the pool.</li>
                            <li>
                                Billing history, invoices, ledger entries, payments, and usage
