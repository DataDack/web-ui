...
function ManagerStatusPill({ state }: Readonly<{ state: ManagerStatusState }>) {
    ...
    return (
        <Badge
            variant="outline"
            className={cn("font-mono text-[11px] gap-1.5", TONE_CLASSES[tone])}
        >
            ...
            <TableRow>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="font-mono text-[11px] text-muted-foreground">
                                    ...
                                    {status.data.status === "healthy" &&
                                        ` · ${String(status.data.latency_ms)}ms`}
                                </span>
                            </div>
                        )
                    })()}
                ...
                <TableCell>
                    {hasSecret ? (
                        <Badge
                            variant="outline"
                            className={cn("gap-1.5 text-[11px]", TONE_CLASSES.success)}
                        >
                        ...
                        <Badge
                            variant="outline"
                            className={cn("gap-1.5 text-[11px]", TONE_CLASSES.neutral)}
                        >
                ...
                <TableCell>
                    <div className="flex items-center justify-end gap-2">
                        ...
                        >
                            <Activity
                                className={cn("size-4", status.isFetching && "animate-pulse")}
                            />
                    ...
                    <div className="overflow-x-auto">
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    <TableHead>
                                        {t("superAdmin.loadBalancers.table.node")}
                                    </TableHead>
                                    <TableHead>
                                        {t("superAdmin.loadBalancers.table.manager")}
                                    </TableHead>
                                    <TableHead>
                                        {t("superAdmin.loadBalancers.table.clientId")}
                                    </TableHead>
                                    <TableHead>
                                        {t("superAdmin.loadBalancers.table.secret")}
                                    </TableHead>
