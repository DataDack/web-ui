...
export const SUPERADMIN_QUERY_KEYS = {
  ...
  clusterInventory: (id: string, query: unknown) =>
    ["superadmin", "pve-cluster", id, "inventory", query] as const,
  ...
  clusterNetworks: ["superadmin", "networking", "clusters"] as const,
  clusterNetwork: (az: string) => ["superadmin", "networking", "clusters", az] as const,
  ...
  usageReport: ["superadmin", "usage-report"] as const,
