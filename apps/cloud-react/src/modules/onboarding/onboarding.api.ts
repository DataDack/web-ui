...
export const onboardingApi = {
  ...
  confirmEmailOTP: (otp: string) => apiPost<null>("/auth/onboarding/verify-email/confirm", { otp }),
  sendPhoneOTP: (phone: string) =>
    apiPost<OTPSentResponse>("/auth/onboarding/verify-phone/send", { phone }),
  confirmPhoneOTP: (otp: string) => apiPost<null>("/auth/onboarding/verify-phone/confirm", { otp }),
