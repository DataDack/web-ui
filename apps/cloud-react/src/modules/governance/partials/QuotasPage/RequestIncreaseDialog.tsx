    ...
    >
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>{t("governance.quotas.dialog.description")}</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            >
              <SelectTrigger className="w-full">
                <SelectValue placeholder={t("governance.quotas.dialog.quotaPlaceholder")} />
              </SelectTrigger>
              <SelectContent>
                {options.map((q) => (
          ...
          <div className="space-y-1.5">
            <Label htmlFor="quota-new-limit">{t("governance.quotas.dialog.newLimit")}</Label>
