...
export function TaxRegistrationFormPage() {
  ...
  return (
    <div>
      ...
      <form onSubmit={(e) => void form.handleSubmit(onSubmit)(e)} className="space-y-5 max-w-2xl">
        {/* ── Registration ─────────────────────────────────────── */}
        <Section variant="panel" className="space-y-5">
          ...
          <Field label={t("taxSettings.fields.country")} hint={t("taxSettings.hints.country")}>
            <Controller
          ...
          {customerType === "business" ? (
            <>
              ...
              <Field label={t("taxSettings.fields.pan")} hint={t("taxSettings.hints.panBusiness")}>
                <Input value={derivedPan} readOnly placeholder="—" className="font-mono" />
              </Field>
        ...
        {/* ── Legal address ────────────────────────────────────── */}
        <Section variant="panel" title={t("taxSettings.legalAddress")} className="space-y-5">
          {customerType === "business" && (
            <Field
