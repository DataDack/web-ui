...
export function useCreateListener(lbId: string) {
    ...
    return useMutation({
        ...
        onError: (e) =>
            toast.error(extractError(e, t("loadBalancers.listeners.toasts.createFailed"))),
    })
}
...
export function useUpdateListener(lbId: string) {
    ...
    return useMutation({
        ...
        onError: (e) =>
            toast.error(extractError(e, t("loadBalancers.listeners.toasts.updateFailed"))),
    })
}
...
export function useDeleteListener(lbId: string) {
    ...
    return useMutation({
        ...
        onError: (e) =>
            toast.error(extractError(e, t("loadBalancers.listeners.toasts.deleteFailed"))),
    })
}
