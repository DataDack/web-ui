...
import { Input, KeyValueGrid, Label, css, cx, fontMono, media } from "@datadack/common-ui"
      ...
      {editing ? (
        ...
        <KeyValueGrid
          ...
          items={[
            ...
            { label: fields.description, value: fn.description },
            {
              label: fields.memory,
            ...
            },
            {
              ...
              value:
                fn.ephemeralStorageMb != null ? `${String(fn.ephemeralStorageMb)} MB` : undefined,
              mono: true,
            },
          ]}
        />
