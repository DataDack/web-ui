...
//
// Ported from cloud-react's managed-apps env editor so the serverless console
// splits a pasted file by exactly the same rules — one grammar, not two that
// drift. Kept dependency-free for the same reason it was there.
//
